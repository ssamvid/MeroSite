    ...
    <section id="about" className="mx-auto max-w-4xl px-6 py-16">
      <Reveal>
        ...
        <p className="mt-4 max-w-2xl text-base leading-relaxed text-muted">
          ...
          like using AI tools to build real projects: when my team needed a
          backend, I didn&apos;t just write endpoints, I owned the database,
          the login security, and a real OTP recovery flow, end to end,
          mostly on my own. I care about the parts of software that quietly
